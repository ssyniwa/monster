...
BASE_MONSTERS = {
    ...
    "ゴースト": {
        "hp": 60, "atk": 40, "spd": 90, "img_key": "gost", 
        "desc": "霊体のモンスター。攻撃力は低いが、すばやさが高い。",
        "skills": ["ゴーストタッチ", "幽霊の囁き"] 
    },
    "溶岩ゴーレム": {
        "hp": 300, "atk": 80, "spd": 20, "img_key": "heat", 
        "desc": "溶岩でできたゴーレム。HPが高いが、すばやさは低い。",
        "skills": ["マグマパンチ", "溶岩の鎧"]
    },
    "氷河のウルフ": {
        "hp": 110, "atk": 55, "spd": 75, "img_key": "ice", 
        "desc": "氷河に生息するウルフ。氷の力を持つ。",
        "skills": ["アイスブレス", "氷の鎖"] 
    },
}
